...
3. Confirm in one line that it is installed. Then tell them the one thing to try: /audit your-resume.pdf
...
- **Anything else**: fall back to the deep read below on its own, and say plainly that the lens is generic.
